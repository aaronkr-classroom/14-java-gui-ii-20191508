	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == btn1) {
			...
			JOptionPane.showMessageDialog(this,
					"JOPtionPane","대화상자",JOptionPane.ERROR_MESSAGE);
		}
		
		else if (obj == btn2) {
			btn2.setBackground(Color.CYAN);
			JOptionPane.showMessageDialog(this,
					"JOPtionPane","대화상자",JOptionPane.INFORMATION_MESSAGE);
		}
		else if (obj == btn3) {
			btn3.setBackground(Color.CYAN);
			JOptionPane.showMessageDialog(this,
					"JOPtionPane","대화상자",JOptionPane.WARNING_MESSAGE);
		}
		else if (obj == btn4) {
			btn4.setBackground(Color.CYAN);
			JOptionPane.showMessageDialog(this,
					"JOPtionPane","대화상자",JOptionPane.QUESTION_MESSAGE);
		}
	}
